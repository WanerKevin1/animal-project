El proyecto esta montado por partes, por un lado tenemos lo que es la API en si, y por otro un proyecto que es del cual depende la API que es de el que cuelga toda la logica de datos o de negocios.
